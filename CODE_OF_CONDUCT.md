...
requests, and any discussion channel the project runs — and also applies when an individual is
officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
maintainers through GitHub's private reporting on
<https://github.com/robsonkades/mohs/security/advisories/new>, or by opening an issue if the matter is
not sensitive. All complaints will be reviewed and investigated promptly and fairly, and the privacy
