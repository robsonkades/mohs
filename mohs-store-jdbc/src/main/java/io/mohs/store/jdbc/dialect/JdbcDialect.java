 ...
 * io.mohs.store.jdbc.JdbcClaimer#claim}, não de fragmentos concatenáveis — o
...
public interface JdbcDialect {
     ...
     * ({@code io.mohs.store.jdbc.JdbcClaimer} reordena pela ordem dos
     ...
     * {@code io.mohs.store.jdbc.JdbcExecutionStore#findPage} precisa do mesmo
