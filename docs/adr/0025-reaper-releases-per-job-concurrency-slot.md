...
(`docs/adr/0012-liveness-heartbeat-lease-reaper.md`) define o
...
## Source
ADR-0009 (`docs/adr/0009-queue-enforcement.md`) — precedente do risco
de drift de contador sob morte de nó. ADR-0012
(`docs/adr/0012-liveness-heartbeat-lease-reaper.md`) — mecanismo do
reclaimer. ADR-0018 (`docs/adr/0018-cas-guarded-claim-not-lock-reliant.md`)
e ADR-0020 (`docs/adr/0020-per-job-concurrency-cap.md`) — pendência já
