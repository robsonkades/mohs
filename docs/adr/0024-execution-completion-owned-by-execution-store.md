...
estado). ADR-0016 (`docs/adr/0016-claim-and-running-are-atomic.md`) e
ADR-0018 (`docs/adr/0018-cas-guarded-claim-not-lock-reliant.md`) —
precedente do SQL cru do `Claimer` pra `RUNNING` e o motivo (join entre
duas tabelas) que não se repete na conclusão. ADR-0020
(`docs/adr/0020-per-job-concurrency-cap.md`) — confirma que a exceção
