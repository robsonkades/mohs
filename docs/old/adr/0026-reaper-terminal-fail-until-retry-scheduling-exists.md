...
## Context
A ADR-0012 (`0012-liveness-heartbeat-lease-reaper.md`) decide
...
## Source
ADR-0012 (`0012-liveness-heartbeat-lease-reaper.md`) — decisão
...
(`0025-reaper-releases-per-job-concurrency-slot.md`) —
