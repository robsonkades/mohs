...
`../MOHS-DOCUMENTO-MESTRE.md` já nomeia o M1 inteiro como "Contratos
...
`0013-public-api-subpackaging.md`;
`../MOHS-DOCUMENTO-MESTRE.md` §9 (nomeia M1 como "Contratos do core");
