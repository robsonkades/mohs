...
- **Onde:** `docs/adr/0017-claim-per-job-mutex-and-queue-admission.md`, seção "Alternativas consideradas
...
- **Onde:** `src/main/java/io/mohs/jdbc/JdbcBatchStore.java:56-65` (`incrementSucceeded`/
  `incrementFailed` — corretamente atômicos, sem SELECT prévio) vs. `docs/adr/0009-queue-enforcement.md`,
...
- **Problema:** o Javadoc de `JobSpec` e `docs/API-DESIGN.md` afirmam que a exclusão mútua entre
...
- **Problema:** `docs/API-DESIGN.md` chama a trilha de actor de "inegociável"; ambos os tipos exigem
...
tabela de `docs/REST-API-DESIGN.md`.
...
- **Onde:** `src/main/java/io/mohs/jdbc/JdbcJobStore.java:163-173`; contraste com
  `docs/adr/0006-registration-lifecycle-and-conflict-policy.md:36-42`.
...
- **Onde:** `docs/MOHS-DOCUMENTO-MESTRE.md:181`, `docs/API-DESIGN.md:622`,
  `docs/adr/0001-single-module-packaging.md:31` — todos afirmam que `io.mohs.engine`/`io.mohs.jdbc` são
...
- **Onde:** `docs/MOHS-DOCUMENTO-MESTRE.md:566-583`, §8 "Plano de ADRs" — lista 0001-0016 e para. A
  `docs/adr/0017-claim-per-job-mutex-and-queue-admission.md` existe, está **Decided** (2026-08-13), e não
