...
A pendência 1 de `../PENDENCIAS.md` perguntava: TTL dedicado ainda no M3, ou junto com a
retenção?
...
## Source
`../PENDENCIAS.md` item 1 (origem: `codereview-20260815-0332.md`);
`../codereview-tuning.md` DBTUNE-9; `../REST-API-DESIGN.md` "Idempotency-Key";
