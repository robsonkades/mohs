...
20260815 (pendência 2 de `docs/PENDENCIAS.md`) apontou que a intenção estava invisível: fácil
...
## Source
`docs/PENDENCIAS.md` item 2 (origem: `codereview-20260815-0332.md`); ADR-0011;
