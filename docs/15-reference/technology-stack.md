...
Status: Active · Last Reviewed: 2026-08-29 · Source of Truth: Repository (`pom.xml`, `package.json`)
...
| ArchUnit | **1.4.1** (`archunit-junit5`) | Twelve executable architecture rules |
| Spring Boot Test | BOM-managed | Context slices |

**Not present**: JMH, JaCoCo, mutation testing, any frontend test framework.
...
| --- | --- | --- |
| `maven-compiler-plugin` | 3.14.0 | Release 25, `-parameters` |
...
| `spring-boot-maven-plugin` | 4.1.0 | Repackage, `mohs-demo` only |
