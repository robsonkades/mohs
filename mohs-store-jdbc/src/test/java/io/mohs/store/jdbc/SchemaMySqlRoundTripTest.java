...
/**
 * ADR-0023: prova que o schema (todo ele, não só o que {@code JdbcWorkQueue} toca) e o DML de cada store fazem round-trip contra
 * MySQL real, não só H2/Postgres — em particular {@code
 * mohs_execution.payload}/{@code mohs_attempt.error} (`TEXT`) e as
