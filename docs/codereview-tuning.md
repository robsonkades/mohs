...
os 4 schemas por dialeto, `pom.xml`, ADRs 0022-0025, `docs/performance/`), com três lentes
que `docs/codereview.md` (2026-08-13) não cobriu nessa profundidade: (1) uso do estado da
...
de claim já medido em `docs/performance/BASELINE.md` (`(state, priority, scheduled_at)`,
