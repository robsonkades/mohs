-- Phase 4 do redesign (ADR-0051): a liveness passa do lease por execução
...
-- Idempotente como toda migração daqui (ADR-0048): schema-*.sql continua
...
-- correlacionadas — node_id novo a cada boot, ADR-0041) o escolheria no
