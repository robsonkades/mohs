...
Companheiro da ADR-0043, no mesmo espírito de `RATE-LIMIT-EVOLUTION.md`:
...
ou Javadoc, como manda `PENDENCIAS.md`.
...
**Saídas.** Coluna nova (esbarra no item 10 de `PENDENCIAS.md`), um
