...
/**
 * O contrato de {@link EngineMetrics} com o redesign (§14.4 do
 * ARCHITECTURE_REDESIGN_PLAN): nomes {@code mohs.*}, labels limitados
 * ({@code job}, {@code outcome}, {@code reason} — nunca id de execução) e
 * a regra de contagem que separa attempt de execução (retry conta attempt,
 * não desfecho de execução).
 */
