...
organização (`../codereview-naming.md`, achado RESP-1) identificou essa tensão entre a regra
...
## Source
`../codereview-naming.md`, achado RESP-1 (2026-08-14); `io.mohs.engine.Claimer`/`Reaper` (Javadoc,
