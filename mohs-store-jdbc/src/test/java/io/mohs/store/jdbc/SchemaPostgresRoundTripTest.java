...
/**
 * ADR-0022: prova que o schema (todo ele, não só o que {@code JdbcWorkQueue} toca) e o DML de cada store fazem round-trip contra Postgres real, não
 * só H2 — em particular {@code mohs_execution.payload}/{@code
 * mohs_attempt.error} (`TEXT`, ex-`CLOB` — DB-3), a divergência real
