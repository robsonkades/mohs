...
/** {@code GET /rate-limits} · {@code PATCH /rate-limits/{name}} — mesmo contrato de {@link QueuesController}, pra vazão em vez de concorrência. */
@RestController
@RequestMapping("/api/mohs/v1/rate-limits")
