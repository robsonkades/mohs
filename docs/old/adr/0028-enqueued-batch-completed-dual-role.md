...
campos (4 para cada tipo). Um review de nomenclatura e organização (`../codereview-naming.md`,
...
## Source
`../codereview-naming.md`, achado RESP-2 (2026-08-14); `io.mohs.core.event.Enqueued`/
