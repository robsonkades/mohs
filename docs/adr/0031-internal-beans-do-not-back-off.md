...
o recuo. O review 20260815 (item 5 de `docs/PENDENCIAS.md`, via o plano de refactor de
...
## Source
`docs/PENDENCIAS.md` item 5 (origem: plano de refactor de `io.mohs.autoconfigure`, removido
